#!/usr/bin/env python3
"""Minimal JPEG upload receiver for Raspberry Pi.
...
HOST = "0.0.0.0"
PORT = 8080
OUTPUT_DIR = Path("captures_raspi")
...
class UploadHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, fmt: str, *args) -> None:
        print(f"[raspi] {self.address_string()} - {fmt % args}")


if __name__ == "__main__":
    print(f"Raspberry Pi receiver listening on http://{HOST}:{PORT}/upload")
