#!/usr/bin/env python3
"""Minimal JPEG upload receiver for PC.
...
class UploadHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, fmt: str, *args) -> None:
        print(f"[pc] {self.address_string()} - {fmt % args}")


if __name__ == "__main__":
    print(f"PC receiver listening on http://{HOST}:{PORT}/upload")
